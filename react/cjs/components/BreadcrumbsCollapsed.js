...
const BreadcrumbsCollapsed = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  ...
  const colors = {
    bg: (0, _cls.cls)('bg-black bg-opacity-15', dark('dark:bg-white dark:bg-opacity-15')),
    dotBg: (0, _cls.cls)('bg-black', dark('dark:bg-white')),
    ...colorsProp
  };
  ...
  const c = themeClasses((0, _BreadcrumbsCollapsedClasses.BreadcrumbsCollapsedClasses)({ ...props
  }, colors), className);
