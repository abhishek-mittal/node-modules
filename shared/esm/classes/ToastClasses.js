...
export const ToastClasses = (props, colors, classes) => {
  ...
  return {
    base: {
      common: cls(colors.text, positionClass('fixed', classes), 'z-50 transform transition-transform-opacity w-full sm:w-auto left-0 bottom-0 sm:max-w-lg', !opened && 'translate-y-full opacity-0 pointer-events-none'),
