...
export const LinkClasses = (props, _ref, classes) => {
  ...
  return {
    base: {
      common: cls(textColor, `inline-flex space-x-1 justify-center items-center cursor-pointer select-none`, needsTouchRipple && `touch-ripple-primary ${positionClass('relative', classes)} z-10`),
      notTabbar: {
