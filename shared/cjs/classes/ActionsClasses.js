...
const ActionsClasses = (props, classes) => {
  return {
    base: {
      common: (0, _cls.cls)('transition-transform duration-300 z-40 left-1/2 bottom-0 transform -translate-x-1/2 max-w-md w-full', (0, _positionClass.positionClass)('fixed', classes)),
