...
const ListInputClasses = (props, colors, _ref) => {
  ...
  return {
    ...
    label: {
      ...
      floating: {
        common: (0, _cls.cls)(`pointer-events-none duration-200 transform origin-left`, isFloatingTransformed && 'scale-133'),
    ...
    inputWrap: {
      common: 'relative',
      ios: '-mb-2.5',
      material: hairlines ? `hairline-b hairline-duration-200 ${getHairlineColor()} ${isFocused || error ? 'hairline-b-scale' : ''}` : '',
      inline: {
    ...
    input: {
      ...
      ios: 'h-11',
      material: 'h-9',
      notFloating: (0, _cls.cls)('placeholder-black placeholder-opacity-30', darkClasses('dark:placeholder-white dark:placeholder-opacity-30'), type === 'textarea' && 'py-3'),
    ...
    info: 'opacity-50',
    clearButton: {
      common: 'absolute right-0 top-1/2 transform -translate-y-1/2 cursor-pointer opacity-45 active:opacity-30',
      ios: 'w-3.5 h-3.5',
