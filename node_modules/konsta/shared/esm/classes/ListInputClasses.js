...
export const ListInputClasses = (props, colors, _ref) => {
  ...
  return {
    ...
    label: {
      ...
      floating: {
        common: cls(`pointer-events-none duration-200 transform origin-left`, isFloatingTransformed && 'scale-133'),
    ...
    input: {
      ...
      ios: 'h-11',
      material: 'h-9',
      notFloating: cls('placeholder-black placeholder-opacity-30', darkClasses('dark:placeholder-white dark:placeholder-opacity-30'), type === 'textarea' && 'py-3'),
