...
export const SegmentedClasses = (props, colors, darkClasses) => {
  ...
  return {
    ...
    strong: cls('p-0.5 bg-black bg-opacity-5 space-x-1 relative', darkClasses('dark:bg-white dark:bg-opacity-10')),
    strongHighlight: cls('absolute left-0.5 top-0.5 bottom-0.5 !ml-0 pointer-events-none duration-200', rounded ? 'rounded-full' : 'rounded', `bg-white shadow`, darkClasses('dark:bg-opacity-15 dark:touch-ripple-white'))
  };
};