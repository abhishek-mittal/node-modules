...
const Chip = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  ...
  const colors = {
    bg: (0, _cls.cls)(`bg-black bg-opacity-10`, dark('dark:bg-white dark:bg-opacity-10')),
    text: 'text-current',
    border: (0, _cls.cls)(`border-black border-opacity-10`, dark('dark:border-white dark:border-opacity-10')),
    ...colorsProp
  };
